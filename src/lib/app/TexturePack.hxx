...
inline void TexturePack::draw(olc::PixelGameEngine *pge,
...
inline olc::vi2d TexturePack::spriteCoords(const Pack &pack, const olc::vi2d &coord, int id) const
{
  ...
  return olc::vi2d((lID % pack.layout.x) * pack.sSize.x, (lID / pack.layout.x) * pack.sSize.y);
}
