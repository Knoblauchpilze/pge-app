...
namespace pge {
  ...
  class CoordinateFrame: public utils::CoreObject {
    public:
      ...
      CoordinateFrame(const CenteredViewportF& cells,
      ...
      virtual olc::vf2d
      tilesToPixels(float x, float y) const noexcept = 0;
      ...
      virtual olc::vf2d
      pixelsToTiles(float x, float y) const noexcept = 0;

      olc::vi2d
      pixelsToTiles(const olc::vi2d& pixels,
      ...
      void
      translate(const olc::vi2d& trackedOrigin);
